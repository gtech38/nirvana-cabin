...
export default function HomePage() {
  return (
    <div style={{ backgroundColor: '#F7F4EF' }}>
        ...
        <div className="relative h-full flex flex-col items-center justify-end pb-24 px-6 text-center text-white">
          <div className="animate-fade-up">
            ...
            <h1
              ...
              style={{ fontSize: 'clamp(3.5rem, 9vw, 7.5rem)', letterSpacing: '0.08em', lineHeight: 1 }}
            >
              Nirvana Cabin
            </h1>
            <p className="text-white/70 text-sm tracking-[0.18em] uppercase mb-10 font-light">
              5 Bedrooms &nbsp;·&nbsp; Sleeps 2–16 &nbsp;·&nbsp; Hot Tub Above the Tree Line
            </p>
          </div>
          <div className="animate-fade-up animate-fade-up-delay-2 flex flex-col sm:flex-row gap-4 items-center">
            <Link
              to="/book"
              className="px-10 py-4 bg-[#B8965A] text-white text-xs tracking-[0.22em] uppercase font-medium hover:bg-[#A07F47] transition-colors"
            >
              Reserve Your Stay
            </Link>
            <Link
              to="/photos"
              className="px-10 py-4 border border-white/50 text-white text-xs tracking-[0.22em] uppercase font-medium hover:border-white hover:bg-white/10 transition-all"
            >
              View Photos
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-28 lg:py-36">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 relative">
            ...
            />
            {/* floating stat card */}
            <div className="absolute -bottom-8 -right-4 lg:-right-10 bg-[#1A2B22] text-white px-8 py-6 shadow-2xl">
              <p className="font-display text-4xl font-light text-[#D4B483]">16</p>
              <p className="text-xs tracking-[0.18em] uppercase text-white/50 mt-1">Max Guests</p>
            </div>
          </div>
      ...
      <section style={{ backgroundColor: '#1A2B22' }} className="py-28 lg:py-36">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10">
            {[
              ...
              <div key={title} className="relative group overflow-hidden" style={{ height: '480px' }}>
                <img
                  src={img.url}
                  alt={title}
      ...
      {/* ── BEDROOMS ── dark */}
      <section style={{ backgroundColor: '#F2EFE9' }} className="py-28 lg:py-36">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
      ...
      <section className="py-28 lg:py-36">
        ...
        <div className="flex gap-3 overflow-x-auto pb-3 px-6 lg:px-12"
          ...
          {images.slice(0, 14).map(img => (
            <div key={img.id} className="flex-shrink-0 overflow-hidden group" style={{ width: '320px', height: '420px' }}>
              <img
                src={img.url}
                alt={img.caption}
      ...
      <section className="relative overflow-hidden" style={{ height: '60vh', minHeight: '400px' }}>
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/book"
              className="px-12 py-4 bg-[#B8965A] text-white text-xs tracking-[0.22em] uppercase font-medium hover:bg-[#A07F47] transition-colors"
            >
              Reserve Now
            </Link>
            <a
              href={`tel:${property.phone}`}
              className="px-12 py-4 border border-white/40 text-white text-xs tracking-[0.22em] uppercase font-medium hover:bg-white/10 transition-colors"
            >
              {property.phone}
            </a>
          </div>
